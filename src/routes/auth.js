...
const {login, signup, users, recover, updateRole, deleteUser, passwordRecovery, change_password, changePassword, userById, setPreferredAddress, getPreferredAddress, } = require("../controllers/auth");
...
function auth(app) {
  ...
  authRouter.get('/users/:id', userById); //en desarrollo
  authRouter.post('/user/:id/preferred-address', setPreferredAddress); 
